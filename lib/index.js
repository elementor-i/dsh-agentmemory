...
export function apply(ctx, config) {
    ...
    if (resolved.registerTools) {
        ...
        ctx.effect(() => ctx.tools.register(buildObserveTool(client, resolved.timeoutMs, () => resolveProject(process.cwd(), resolved.projectName), () => process.cwd(), () => state.lastSessionId)));
